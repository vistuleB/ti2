...
export default function _() {
    return (
        <>
            <div id="link-to-toc">
                <p><a href="../vorlesungsskript">Inhaltsverzeichnis</a></p>
                <p><a href="01-00-BooleanCircuits">&lt;&lt; Kapitel 1</a></p>
            </div>

            <div id="link-to-overview">
                <p><a href="https://www.tu-chemnitz.de/informatik/theoretische-informatik/TI-2/index.html">zur Kursübersicht</a></p>
                <p><a href="01-02-Fanin-Size-Depth">Kapitel 1.2 &gt;&gt;</a></p>
            </div>
                        ...
                        <div class='chapter'>
                            <div class='subChapter'>
                                <h1 class='hidden-title'>
                                    <span class='subChapterTitle'>1.1 Größe, Tiefe, Fan-In</span>
                                </h1>
                                ...
                                <figure>
                                    <img loading='lazy' src='../img/circuits/and-n-fold-linear-depth.svg' style='height:10em' />
                                    oder alternativ:
                                    <img loading='lazy' src='../img/circuits/and-n-fold-log-depth.svg' style='height:10em' />
                                </figure>
                                <p>
