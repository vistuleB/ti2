...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 118).
-spec display(list(binary())) -> gleam@dict:dict(binary(), list(binary())).
display(Values) ->
    maps:from_list([{<<"display"/utf8>>, Values}]).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 136).
-spec color(list(binary())) -> gleam@dict:dict(binary(), list(binary())).
color(Values) ->
    maps:from_list([{<<"color"/utf8>>, Values}]).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 154).
-spec background(list(binary())) -> gleam@dict:dict(binary(), list(binary())).
background(Values) ->
    maps:from_list([{<<"background"/utf8>>, Values}]).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 213).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 323).
-spec arguments() -> list(binary()).
arguments() ->
    shellout_ffi:start_arguments().

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 407).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 450).
-spec exit(integer()) -> nil.
exit(Status) ->
    shellout_ffi:os_exit(Status).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 474).
-spec which(binary()) -> {ok, binary()} | {error, binary()}.
which(Executable) ->
    shellout_ffi:os_which(Executable).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 226).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/shellout/src/shellout.gleam", 188).
-spec style(
    binary(),
