...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 140).
-spec snag_inspect_error({ok, CGV} | {error, any()}) -> {ok, CGV} |
    {error, snag:snag()}.
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 165).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 116).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 100).
    ...
    gleam@result:'try'(
        ...
        fun(Files) -> _pipe@2 = Files,
            _pipe@3 = gleam@list:filter(
                _pipe@2,
                fun(F) ->
                    not gleam_stdlib:contains_string(F, <<"@@"/utf8>>) andalso (gleam_stdlib:string_ends_with(
                        F,
                        <<".beam"/utf8>>
                    )
                    orelse gleam_stdlib:string_ends_with(F, <<".app"/utf8>>))
                end
            ),
            {ok, _pipe@3} end
    ).

-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 32).
...
-file("/Users/jpsteinb/github.com/vistuleB/solid-project/spotlight/build/packages/gleescript/src/gleescript.gleam", 17).
-spec main() -> nil.
main() ->
    case run() of
        {ok, _} ->
        ...
        {error, Error} ->
            gleam_stdlib:println_error(snag:pretty_print(Error)),
            init:stop(1)
    end.
